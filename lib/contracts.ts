...
// NEXT_PUBLIC_NETWORK accepts "mainnet" | "testnet" (defaults to testnet/Base Sepolia)
const ACTIVE_CHAIN_ID: SupportedChainId =
  process.env.NEXT_PUBLIC_NETWORK === "mainnet" ? 8453 : 84532;
